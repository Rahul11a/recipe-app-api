...
def image_upload_url(recipe_id):
    """Returns the url for recipe image upload"""
...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_partial_update_recipe(self):
        ...
        payload = {'title': 'Vegetable Curry', 'tags': [new_tag.id]}
        url = detail_url(recipe.id)
    ...
    def test_full_update_recipe(self):
        ...
        # Put command wipes the data and then override
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Manchurian gravy')
        tag1 = sample_tag(user=self.user, name='vegan')
        tag2 = sample_tag(user=self.user, name='vegetble')
        recipe1.tags.add(tag1)
        recipe2.tags.add(tag2)
        recipe3 = sample_recipe(user=self.user, title='Fish fingers')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Black bean toast')
        recipe2 = sample_recipe(user=self.user, title='White pasta')
        ingredient1 = sample_ingredient(user=self.user, name='Cheddar cheese')
        ingredient2 = sample_ingredient(user=self.user, name='Pasta')
        recipe1.ingredients.add(ingredient1)
        recipe2.ingredients.add(ingredient2)
        recipe3 = sample_recipe(user=self.user, title='Mug cake')
